          ...
          <section className="space-y-6">
            ...
            <Painel titulo="Agenda do dia" subtitulo="Escolha a data e a profissional; os horários ocupados ficam bloqueados automaticamente.">
              <div className="mb-5 grid gap-4 md:grid-cols-3">
                <div><label className="mb-1 block text-sm text-zinc-300">Data</label><DatePickerBR value={dataAgenda} onChange={setDataAgenda} className="w-full rounded-2xl border border-zinc-700 bg-black px-4 py-4 text-white outline-none transition focus:border-[#d7b56d]" /></div>
